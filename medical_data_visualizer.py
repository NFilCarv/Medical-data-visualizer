...
def draw_cat_plot():
    ...
    fig = sns.catplot(
        ...
        height=6,
        aspect=1
    ).fig  # Access the figure from FacetGrid

    # 8 - Get the figure for the output and store it in the fig variable.
    fig.axes[0].set_xlabel("variable")  # Set x-axis label
    fig.axes[0].set_ylabel("total")     # Set y-axis label
...
def draw_heat_map():
    ...
    sns.heatmap(corr, mask=mask, annot=True, fmt='.1f', cmap='coolwarm', ax=ax, cbar_kws={'shrink': 0.8})
